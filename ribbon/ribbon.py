...
if __name__ == "__main__":
    ...
    random_walker = RandomWalker(links=my_links, max_size=max_size, max_bct=args.max_bands, logger=logger, log_level=log_level, use_band_checks=args.use_checks, save_solved_knot_images=args.save_images)
