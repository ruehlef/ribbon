...
4. Download <a id="raw-url" href="https://github.com/ruehlef/ribbon/raw/main/examples/test_ribbon.py">this file</a> (after following the link, click on File->Save as... and download the file to your home directory).
